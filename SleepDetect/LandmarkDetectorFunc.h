...
namespace LandmarkDetector
{
	...
	cv::Rect DetectLandmarksInVideo(const cv::Mat_<uchar> &grayscale_image, const cv::Mat_<float> &depth_image, CLNF& clnf_model, FaceModelParameters& params, bool &track_success_return);
