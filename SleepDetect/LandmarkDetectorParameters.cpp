...
void FaceModelParameters::init()
{
    ...
    model_location = std::string("/Users/alexross/Downloads/SleepDetect/model/main_clnf_general.txt");
//   std::cout<< "model_location = " << model_location << std::endl;
//    /Users/alexross/Downloads/test_console/model/main_clnf_general.txt
    sigma = 1.5;
    reg_factor = 25;
    ...
    face_detector_location = std::string("/Users/alexross/Downloads/SleepDetect/classifiers/haarcascade_frontalface_alt.xml");
