...
//			else
//			{
//				cv::putText(targetImage, "PAUSE", cv::Point(targetImage.cols - 120, targetImage.rows - 10), CV_FONT_HERSHEY_SIMPLEX, 1, cv::Scalar(0, 0, 255), 1);
//
//			}
//
...
//
//		cv::putText(image, "Stamina: N/A", cv::Point(25, image.rows - 50), CV_FONT_HERSHEY_SIMPLEX, 0.7, CV_RGB(255, 255, 255), 2);
//		cv::putText(image, "ID: " + mac, cv::Point(25, image.rows - 30), CV_FONT_HERSHEY_SIMPLEX, 0.7, CV_RGB(255, 255, 255), 2);
//
//		if (!skip)
//		{
//			cv::putText(image, "HotKey ESC: OFF ", cv::Point(25, image.rows - 10), CV_FONT_HERSHEY_SIMPLEX, 0.7, CV_RGB(255, 255, 255), 2);
//		}
//		else
//			cv::putText(image, "HotKey ESC: ON ", cv::Point(25, image.rows - 10), CV_FONT_HERSHEY_SIMPLEX, 0.7, CV_RGB(255, 255, 255), 2);
//
//
...
//}
//
//int main_2211s1(int argc, char * argv[])
//{
//	StartSleepDetect();
//}
